...
export default function Gallery() {
  ...
  useGSAP(
    () => {
      const scrollerEl =
        window.__RBD_SCROLLER__ || document.querySelector(".scrollRoot");
      ...
      textItems.forEach((el, i) => {
        tlShowText
          .fromTo(
            el,
            { autoAlpha: 0, y: "3rem", scale: 1.04 },
            { autoAlpha: 1, y: "0rem", scale: 1, duration: 1 },
            i * 2,
          )
          .to(
            el,
            { autoAlpha: 0, y: "-3rem", scale: 0.96, duration: 1 },
            i * 2 + 1,
          );
      });
      ...
      gsap
        ...
        .fromTo(
          textInner,
          { autoAlpha: 1, scale: 1 },
          { autoAlpha: 0, scale: 0.96, duration: 1 },
        );
      ...
      if (
        ...
        const computeDelta = (fromEl, toEl) => {
          const vpLeft =
            scroller === window ? 0 : scroller.getBoundingClientRect().left;
          const vpTop =
        ...
        startItems.forEach((startEl, i) => {
          ...
          tlImages.fromTo(
            ...
            first,
            {
              x: () => computeDelta(startEl, endEl).x,
              y: () => computeDelta(startEl, endEl).y,
              rotation: 0,
            },
            "<+=0.015",
          );
          ...
          const inner =
            startEl.querySelector(`.${classes.itemInner}`) ||
            startEl.querySelector(":scope > div");
  ...
  return (
    <section
      ...
      ref={wrapRef}
      aria-label="Adriatic tour photo gallery"
    >
            ...
            <div className={classes.textInner} ref={textInnerRef}>
              ...
              >
                <h2 className={classes.heading}>
                  {
                    "Anyone can find the places. Knowing when to be there is the difference."
                  }
                </h2>
              </div>
              <div
              ...
              >
                <h2 className={classes.heading}>
                  {
                    "The cove before the crowd. The shade at the right hour. The small things are the whole thing."
                  }
                </h2>
              </div>
            </div>
      ...
      <div className={classes.main}>
        <div
          ...
          role="list"
          aria-label="Gallery of Adriatic boat tour photos"
        >
